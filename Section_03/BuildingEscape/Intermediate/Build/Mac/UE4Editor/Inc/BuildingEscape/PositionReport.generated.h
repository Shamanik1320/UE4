...
#define BuildingEscape_Source_BuildingEscape_PositionReport_h_12_INCLASS_NO_PURE_DECLS \
	...
	public: \
	DECLARE_CLASS(UPositionReport, UActorComponent, COMPILED_IN_FLAGS(0), 0, BuildingEscape, NO_API) \
	DECLARE_SERIALIZER(UPositionReport) \
	/** Indicates whether the class is compiled into the engine */    enum {IsIntrinsic=COMPILED_IN_INTRINSIC}; \
	virtual UObject* _getUObject() const override { return const_cast<UPositionReport*>(this); }
...
private: \
	...
	NO_API UPositionReport(const UPositionReport& InCopy); \
public:
