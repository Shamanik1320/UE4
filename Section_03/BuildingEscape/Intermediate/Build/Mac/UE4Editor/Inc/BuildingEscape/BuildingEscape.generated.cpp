...
void EmptyLinkFunctionForGeneratedCodeBuildingEscape() {}
	void ABuildingEscapeGameMode::StaticRegisterNativesABuildingEscapeGameMode()
	{
	}
	IMPLEMENT_CLASS(ABuildingEscapeGameMode, 2815245870);
	void UPositionReport::StaticRegisterNativesUPositionReport()
	{
	}
	IMPLEMENT_CLASS(UPositionReport, 2632854107);
...
// Cross Module References
	...
	BUILDINGESCAPE_API class UPackage* Z_Construct_UPackage_BuildingEscape();
	...
	UClass* Z_Construct_UClass_ABuildingEscapeGameMode()
	{
		...
		if (!OuterClass)
		{
			...
			Z_Construct_UPackage_BuildingEscape();
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABuildingEscapeGameMode(Z_Construct_UClass_ABuildingEscapeGameMode, TEXT("ABuildingEscapeGameMode"));
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UPositionReport(Z_Construct_UClass_UPositionReport, TEXT("UPositionReport"));
	DEFINE_VTABLE_PTR_HELPER_CTOR(UPositionReport);
	UPackage* Z_Construct_UPackage_BuildingEscape()
	{
