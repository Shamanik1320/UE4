...
#define BuildingEscape_Source_BuildingEscape_BuildingEscapeGameMode_h_14_INCLASS_NO_PURE_DECLS \
	...
	public: \
	DECLARE_CLASS(ABuildingEscapeGameMode, AGameMode, COMPILED_IN_FLAGS(0 | CLASS_Transient | CLASS_Config), 0, BuildingEscape, NO_API) \
	DECLARE_SERIALIZER(ABuildingEscapeGameMode) \
	/** Indicates whether the class is compiled into the engine */    enum {IsIntrinsic=COMPILED_IN_INTRINSIC}; \
	virtual UObject* _getUObject() const override { return const_cast<ABuildingEscapeGameMode*>(this); }
